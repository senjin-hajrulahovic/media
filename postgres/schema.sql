...
COPY public.country (id) FROM stdin;
\.
...
COPY public.genre (id) FROM stdin;
\.
...
COPY public.media (id, created_at, publishing_date, title, updated_last_at, artist_id, genre_id, originating_country_id, publisher_id) FROM stdin;
\.
